<?php
    ...
    class UserModel {
        ...
        public static function get_users_by(array $arguments, bool $singleResult = false): array|object{
            ...
            $result = Database::execute_query($query, array_values($arguments), $singleResult);

            return $result;
        }

        public static function create_account(array $arguments){
        ...
        public static function update_user(array $arguments, array $whereCondition){
        ...
        public static function filter_users(string $search){
